...
/* https://www.zooniverse.org/projects/edh/weather-rescue/talk/1198/609964?comment=1017198
 * Subject sets unchanged from 1908
 * All column sets:
 *
...
var manifests = Utils.createManifests('1909', locationSets, ColumnSets.ALL);

manifests = manifests.concat(Utils.createManifests('1909', [HaparandaThorshavn], [ColumnSets.PRESSURE_TEMP, ColumnSets.PRESSURE_DRY_WET]));

manifests = manifests.concat(Utils.createManifests('1909', [HaparandaSkudesnaes], [ColumnSets.MAX_MIN_RAINFALL]));
